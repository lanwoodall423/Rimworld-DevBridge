...
4. Use read-only context and command descriptors before any mutation. Acquire explicit write authority only for a necessary mutation and never treat `agentId` as authority.
